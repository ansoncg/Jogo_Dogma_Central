...
public class Transcricao extends Estado {
   ...
   public int atualizar () {
      ...
      if (!perdeu && !ganhou) {
         dnaMolde.atualizar ();
         switch (rnaMensageiro.atualizar ()) {
            case 1:
               ganhou = true;
               break;
            case -1:
   ...
   public void desenhar (Graphics graficos) {
      ...
      graficos.drawImage (Elemento.restoTrans, 0, 20, null);
   ...
   public void reset () {
      ...
      rnaMensageiro = new Sequencia (jogo, "RNA", templateStrand, false, 0, 460);  
      switch (jogo.dificuldade) {
         ...
         case "dificil":
            ...
            rnaMensageiro.setVelocidade (2.0f);
            break;
      }
      perdeu = false;
      ganhou = false;
